...
// BEGIN CUT HERE
	...
	void test_case_0() { int Arr0[] = {1, 5, 10, 4}; vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 10; int Arg2 = 6; verify_case(0, Arg2, find(Arg0, Arg1)); }
...
{
	TheSequencesLevelThree ___test;
